sap.ui.define(["sap/ui/core/UIComponent", "sap/ui/Device", "./model/models"], function (UIComponent, Device, models) {
	...
	return UIComponent.extend("br.com.novaconsulting.admin.Component", {
		metadata: {
			interfaces: [
		...
		init: function () {
			...
			this.setModel(models.createDeviceModel(), "ui");
			this.setModel(models.createDeviceModel(), "appView");
