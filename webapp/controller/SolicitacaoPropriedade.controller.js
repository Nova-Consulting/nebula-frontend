sap.ui.define(["./BaseController", 'sap/ui/model/json/JSONModel', 'sap/m/MessageToast'], function (BaseController, JSONModel, MessageToast ) {
	...
	return BaseController.extend("nebula.controller.solicitacaoPropriedade", {
		onInit: function() {
			...
			this.getOwnerComponent().getRouter().getRoute("solicitacaoPropriedadesRoute").attachPatternMatched(this._onRouteMatched, this);			
			this.lazy(true)
		},
