sap.ui.define(["./BaseController", 'sap/ui/model/json/JSONModel', 'sap/m/MessageToast'], function (BaseController, JSONModel, MessageToast ) {
	...
	return BaseController.extend("nebula.controller.SolicitacaoCooperado", {
		onInit: function() {
			...
			this.getOwnerComponent().getRouter().getRoute("solicitacaoCooperadosRoute").attachPatternMatched(this._onRouteMatched, this);			
			this.lazy(true)
		},
